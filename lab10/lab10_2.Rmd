...
```{r}
p +geom_point(size=2) #change size of the points
```
...
homerange %>% 
  ...
  theme(axis.text.x = element_text(angle = 60, hjust = 1)) + #use the theme to adjust the angle
  labs(title = "Observations by Taxon in Homerange Data",
       x = "Taxonomic Group",
       fill= "Trophic Guild")
```
