...
lat2 <- c(55.02, 70.37)
long2 <- c(-166.2, -131.3)
bbox2 <- make_bbox(long2, lat2, f = 0.05) #adds a little to the bare minimums so that the points dont get stuck on the very edge
```
...
ggmap(map2) + 
  ...
  labs(x= "Longitude", y= "Latitude", title="Grizly Bear Location Alaska")
```
