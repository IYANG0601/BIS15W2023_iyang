...
```{r}
#the NA means that the data doesnt exist, the summarize function is just ignonoring it
```
...
#it says NaN because we literally have no values for cetacea, cant take the mean of nothing
```
