...
```r
#The publication this data comes from is "Proceedings of the National Academy of Sciences.
```
...
```r
#The dimensions are 83 by 11 or 83 "observations" and 11 "variables." 
dim(sleep)
```
...
herbivore <- filter(sleep, vore == "herbi")
dim(herbivore)
```
...
```r
#According to the data, smaller animals sleep longer on average.
